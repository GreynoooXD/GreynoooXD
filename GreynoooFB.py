# [+] Update By GreynooXD And All
# [+] Script Free Jangan Di Perjual Belikan Ya
# [+] Donasi Untuk GreynoooXD 
# [+] Dana : 081388341152
...
from concurrent.futures import ThreadPoolExecutor as GreynoooXD 
...
def menu(my_name,my_id):
	...
	cetak(panel(f"[bold white]Brayennn_XD , DerrXr , Asepit-Gans , Rozhak XD , Rochmat Basuki , Nazri XD , Aorec XD , Lukman-XD , Dapunta , Kall",width=90,title=f"[bold green]Thanks To",style=f"bold white"))
	...
	if _____greynooo___xd____ in ['1','01']:
		...
		print(' [+] Laso Cuma Disuruh Pilih Susah Amat ')
		exit()
def error():
	print(f' [+] Sabar Masih Diperbaiki')
	time.sleep(4)
...
def setting():
	...
	if hu in ['1','01']:
		...
		print(' [+] Pilih Yang Serius Tai Lasso ')
		exit()
	urut = []
